...
Передаточная функция регулятора:
\begin{align*}
    D(z)&=\frac{1}{HG(z)}\frac{T(z)}{1-T(z)}=\frac{z^2-1.5z+0.5}{0.03\left( z+0.75 \right)}\cdot\frac{-28.596z+30.307}{z^2+29.114z-30.114}=\\
    &=\frac{-28.596z^3+73.201z^2-59.759z+15.154}{0.03z^3+0.896z^2-0.248z-0.678}
\end{align*}
