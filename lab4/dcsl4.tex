...
\newpage
Графики управления и выхода системы при ступенчатом задающем воздействии $r(m)$ при $T=1,k=2$:
\begin{figure}[H]
    \centering
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{1y.png}
    \caption{Выход системы с апериодическим регулятором, $T=1,k=2$}
    \label{fig:1y}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{1u.png}
...
Графики управления и выхода системы при ступенчатом задающем воздействии при $T=1,k=1$:
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{2y.png}
    \caption{Выход системы с регулятором Далина, $T=1,k=1$}
    \label{fig:2y}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{2u.png}
