...
Таким образом,
$$
n_d=\frac{1.1}{1}=1\Rightarrow n_d\sim 1\Rightarrow e^{-1.1s}\sim e^{-s}
$$
...
Из условия физической реализуемости выберем $k\geq2$, тогда:
$$
D(z)=\frac{1-0.905z^{-1}}{0.095z^{-2}}\frac{z^{-2}}{1-z^{-2}}=
\frac{z^{-2}-0.905z^{-3}}{0.095z^{-2}\left( 1-z^{-2} \right)}
$$
