...
Положим $k_1=1,\bar{C}=\begin{bmatrix}
    0_{1\times q}&C
\end{bmatrix}$.
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{sch3.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=1]{2yg.png}
...
размерности $l\times k$, при этом $l<n,\operatorname{rank}(C_\text{и})=l$.


Устройство оценки полной размерности:
$$
\hat{x}(m+1)=A\hat{x}(m)+Bu(m)+L(y_\text{и}-C_\text{и}\hat{x}(m)),
$$
