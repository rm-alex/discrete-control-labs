...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.46]{sch4.png}
    \caption{Схема моделирования системы с наблюдателем}
    \label{fig:sch4}
\end{figure}
...
на $2$ до $m=4$ шагов по сравнению с моделированием в пункте (2) -- динамика стала
